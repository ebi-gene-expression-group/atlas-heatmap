...
const Footer = props =>
  <div style={{marginBottom: `2rem`, clear: `both`, width: `100%`}}>
    This page is a summary of the data held in <a href={props.outProxy + props.atlasUrl}>Expression Atlas</a> for this gene; click <a href={props.outProxy + props.moreInformationUrl}>here </a>for the full record.
