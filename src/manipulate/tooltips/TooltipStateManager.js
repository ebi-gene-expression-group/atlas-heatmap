...
import './TooltipStateManager.css'
...
TooltipStateManager.props = {
    managedComponent: PropTypes.any.isRequired,
    managedComponentProps: PropTypes.object.isRequired,
    ...
    enableFreeze: PropTypes.bool.isRequired
}
