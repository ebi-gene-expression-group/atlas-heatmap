...
export const experimentProfilesRowsPropTypes = {
...
export const geneExpressionsPropTypes = {
...
export const geneProfilesRowsPropTypes = {
    id: React.PropTypes.string.isRequired,              // Gene ID
    name: React.PropTypes.string.isRequired,            // Gene name
    expressions: React.PropTypes.arrayOf(React.PropTypes.shape({
        geneExpressionsPropTypes
    })).isRequired
};

// export const OrderingsPropType = (props, propName) => {
...
// };
//
// export const HeatmapDataPropType = (props, propName) => {
