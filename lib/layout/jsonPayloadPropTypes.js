...
var baselineColumnHeadersPropTypes = PropTypes.shape({
...
var assayGroupPropTypes = PropTypes.shape({
    id: PropTypes.string.isRequired,
    assayAccessions: PropTypes.arrayOf(PropTypes.string).isRequired,
    replicates: PropTypes.number.isRequired
});

var differentialColumnHeadersPropTypes = PropTypes.shape({
    id: PropTypes.string.isRequired,
...
var baselineExperimentProfilesRowsPropTypes = PropTypes.shape({
...
var baselineGeneProfilesRowsExpressionsPropTypes = PropTypes.shape({
    value: PropTypes.number,
...
var baselineGeneProfilesRowsPropTypes = PropTypes.shape({
...
var baselineProfilesPropTypes = PropTypes.shape({
    searchResultTotal: PropTypes.string.isRequired,
    rows: PropTypes.arrayOf(PropTypes.oneOfType([baselineExperimentProfilesRowsPropTypes, baselineGeneProfilesRowsPropTypes]))
});

var differentialProfilesPropTypes = PropTypes.shape({
...
var dataPropTypes = PropTypes.shape({
    ...
    columnHeaders: PropTypes.arrayOf(PropTypes.oneOfType([baselineColumnHeadersPropTypes, differentialColumnHeadersPropTypes])).isRequired,
    ...
    profiles: PropTypes.oneOfType([baselineProfilesPropTypes, differentialProfilesPropTypes]).isRequired,
