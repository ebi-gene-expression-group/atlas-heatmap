...
var FiltersModal = function (_React$Component) {
    ...
    function FiltersModal(props) {
        ...
        _this.state = {
            selectedFilters: _this._filtersSelectionBeforeModalOpen(),
            showModal: false
        };

        _this.open = _this._open.bind(_this);
        _this.close = _this._close.bind(_this);
        _this.apply = _this._apply.bind(_this);
        _this.onSelectFilterValue = _this._onSelectFilterValue.bind(_this);
        return _this;
    }

    _createClass(FiltersModal, [{
        key: '_filtersSelectionBeforeModalOpen',
        value: function _filtersSelectionBeforeModalOpen() {
            // Deep copy to avoid modifying props
            return this.props.selectedFilters.map(function (selectedFilter) {
                return {
                    name: selectedFilter.name,
                    valueNames: selectedFilter.valueNames.map(function (valueName) {
                        return valueName;
                    })
                };
            });
        ...
        value: function _onSelectFilterValue(filterName, newFilterValues) {
            this.setState(function (previousState) {
                return {
                    selectedFilters: previousState.selectedFilters.map(function (previousSelectedFilter) {
                        return {
        ...
        value: function _renderFlatFilter(filter) {
            return _react2.default.createElement(_FlatFilter2.default, _extends({ key: filter.name,
                selected: this.state.selectedFilters.find(function (selectedFilter) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _Button2.default,
                            { bsStyle: 'primary', onClick: this.apply,
                                style: { textTransform: 'unset', letterSpacing: 'unset', height: 'unset' } },
                            'Apply'
                        ),
                        _react2.default.createElement(
